...
func TestCreateDataFromService_pass(t *testing.T) {
	...
	ret, err := CreateDataFromService(ts.URL, nil, 5)
	if err != nil {
...
func TestCreateDataFromServiceWithCustomHeader_pass(t *testing.T) {
	...
	ret, err := CreateDataFromServiceWithCustomHeader(ts.URL, nil, headers, 5)
	if err != nil {
		t.Errorf("Erro no envio/recebimento do JSON")
	}
...
func TestDeleteDataFromService_pass(t *testing.T) {
	...
	status, data, err := DeleteDataFromService(ts.URL, 5)
	if err != nil {
		t.Errorf("Erro no processo de delecao")
	}

	i, _:= strconv.Atoi(TestStatusValue)
	if status != i {
...
func TestGetDataFromService_pass(t *testing.T) {
	...
	status, data, err := GetDataFromService(ts.URL, 5)
	if err != nil {
		t.Errorf("Erro no processo de delecao")
	}
...
func TestGetDataFromServiceWithCustomHeader_pass(t *testing.T) {
	...
	ret, err := GetDataFromServiceWithCustomHeader(ts.URL, headers, 5)
	if err != nil {
